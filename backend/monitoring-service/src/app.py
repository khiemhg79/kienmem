...
def start_mqtt():
    ...
    # Xác thực MQTT — đối phó nguy cơ 4.1.3 (chống kết nối vô danh)
    mqtt_client.username_pw_set(MQTT_USER, MQTT_PASS)
    mqtt_client.on_connect = lambda c, u, f, rc: (log.info(f'MQTT connected rc={rc} (authenticated)'), c.subscribe('office/#'))
